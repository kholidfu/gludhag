...
<div class="aboutus wrapper mb30">
    <div class="dark">
      ...
      <div class="column12 biograph">
        <div class="about-title">Terms of Use</div>  
        <div class="about-sub">-----------------------</div>

            <p>PLEASE READ THESE TERMS AND CONDITIONS OF SERVICE CAREFULLY.</p>
            ...
            <p>Privacy Policy And Consumer Education</p>

            <p>In order to use the Services, you agree to be bound by the Privacy Notice of the Site. Please review the Privacy Notice (which may be accessed at the Site) on a regular basis as it may be updated from time to time.</p>
            <p>Copyrights</p>
            ...
            <p>Use Of Content Submitted By You/User/Author</p>

            <p>By uploading, posting, sending or submitting photographs, pictures, images or any other content including, without limitation, graphics, video, data, text, files, links, software, music, sound (”CONTENT“), you are consenting to be bound by these Conditions of Use. If you do not agree, do not upload, post, send or submit any content to this site.</p>
            ...
            <p>User / Member Conduct</p>

            <p>You understand that all Content posted by Users/Authors, whether publicly posted or privately transmitted, are the sole responsibility of the User from which such Content originated. This means that you – the Author, and not us – the Site, are entirely responsible for all Content that you/user/author upload, post, email, transmit or otherwise make available via the Service. We do not control the Content posted via the Service and, as such, do not guarantee the accuracy, integrity or quality of such Content.</p></p>
            ...
            <p>You agree to not use the Service to:</p>
                ...
                <p>upload, post, email, transmit or otherwise make available any Content that is unlawful, harmful, threatening, abusive, harassing, tortuous, defamatory, vulgar, obscene, libelous, invasive of another’s privacy, hateful, or racially, ethnically or otherwise objectionable;</p>
                <p>harm minors in any way;</p>
                <p>impersonate any person or entity, including, but not limited to, a Site official, forum leader, guide or host, or falsely state or otherwise misrepresent your affiliation with a person or entity;</p>
                <p>forge headers or otherwise manipulate identifiers in order to disguise the origin of any Content transmitted through the Service;
                ...
                <p>upload, post, email, link, transmit or otherwise make available any material that contains software viruses or any other computer code, files or programs designed to interrupt, destroy or limit the functionality of any computer software or hardware or telecommunications equipment;</p>
                ...
                <p>”stalk“ or otherwise harass another;</p>
                <p>collect or store personal data about other Users;</p>
                <p>link to or refer to Content not allowed under these TOS;</p>
                <p>otherwise use the service in a manner deemed inappropriate by us.</p>

            <p>Possible Content Removal</p>
            ...
            <p>We retain the right, but not the obligation, to monitor and edit or remove any activity or Content that it deems in its sole discretion to be harmful to Users, us or the rights of any third party, or to violate any applicable law. This includes the right, but not the obligation, to remove any text or images uploaded by you that we deem in our sole judgment to be inappropriate or that we believe may subject us to any liability, including without limitation the following:</p>
                ...
                <p>photographs, pictures, images, text or other materials submitted by Users that are protected by trademark, copyright, right of publicity or other proprietary right, without the express permission of the owner of those rights;</p>
                <p>partially or fully nude images of anyone, at any age, of any gender, including sexually suggestive images or words;</p>
                <p>profanity or offensive comments including but not limited to expressions of racism, bigotry or hatred, or that are abusive, slanderous or offensive;</p>
                <p>any illegal material such as expressions of abuse, offensive language and imagery, obscenity or pornography, including, but not limited to, child abuse, child pornography, depictions of minors engaged in sexual conduct or explicitly sexual situations, or any other material that could give rise to any civil or criminal liability under, or otherwise violate, any applicable law.</p>
            ...
            <p>Claims of Copyright Infringement; Designated Agent</p>
            ...
            <p>Pursuant to the Digital Millennium Copyright Act (”DMCA“), 17 U.S.C. 512(c)(3), the following information must be provided to our Designated Agent,</p>
                ...
                <p>Copyright Agent</p></p>

                <p>dmca@al-maliki.com</p></p></p>

            <p>for notifications:</p></p></p></p>
                ...
                <p>Should you fail to comply with all of the aforementioned requirements in your notice, your notice may not be valid.</p></p>
                <p>It is our policy to terminate the accounts and/or membership of Users who are repeat infringers or who are repeatedly charged with infringement, in appropriate circumstances.</p>

            <p>Termination</p></p>

            <p>In the event that you are a registered user of the Site, you may terminate such registration by notifying the Site by sending e-mail to info@al-maliki.com. After receipt of your termination notice, we will terminate your account.</p>
            <p>We may terminate your access to the Services or your registration at any time in the event of a breach of these TOS by User or anyone accessing the Services using registered User’s username. We, at our sole discretion, may also terminate these TOS at any time without cause, and may suspend access to the Service with or without notice, to any User.</p>
            <p>Indemnification</p>
            ...
            <p>You expressly understand and agree that:</p>
                ...
                <p>We make no warranty that</p></p>
                    <p>the Service will meet your requirements,</p>
                    <p>the Service will be uninterrupted, timely, secure, malware-free or error-free,</p>
                    <p>The results that may be obtained from the use of the service will be accurate or reliable,</p>
                    <p>The quality of any products, services, information, or other material purchased or obtained by you through the service will meet your expectations, and</p>
                    <p>any errors in the software will be corrected.</p>
                <p>any material downloaded, accessed, viewed or otherwise obtained through the use of the service is done at your own discretion and risk and that you will be solely responsible for any damage to your computer system or loss of data that results from the download of any such material.</p>
                ...
                no advice or information, whether oral or written, obtained by you from us or the site or through or from the service shall create any warranty not expressly stated in the tos.</p>
            ...
            <p>you expressly understand and agree that we shall not be liable for any direct, indirect, incidental, special, consequential or exemplary damages, including but not limited to, damages for loss of profits, goodwill, use, data or other intangible losses (even if we have been advised of the possibility of such damages), resulting from:</p>
                ...
                <p>the cost of procurement of substitute goods and services resulting from any goods, data, information or services purchased or obtained or messages received or transactions entered into through or from the service;</p>
                <p>unauthorized access to or alteration of your transmissions or data;</p>
                <p>statements or conduct of any third party on the service; or</p>
                <p>any other matter relating to the service.</p>
            ...
            <p>Please report any violations of the TOS to abuse@al-maliki.com, titled: Abuse/Violation; or make any comments to info@al-maliki.com.</p>
      </div>
