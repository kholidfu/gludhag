...
@section('title') {{ env('DOMAIN_NAME') }} | {{ $desc->walltitle }} {{ env('TITLE_DIVIDER') }} {{ env('DOMAIN_DESC') }}@stop
...
<meta name="distribution" content="Global" />
  ...
  <meta property="og:title" content="{{ env('DOMAIN_NAME') }} | {{ $desc->walltitle }}">
  <meta property="og:description" content="{{ $desc->walltitle }} : {{ env('DOMAIN_NAME') }}">
